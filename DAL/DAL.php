<?php
require_once($_SERVER['DOCUMENT_ROOT'].'Models/VijestModel.php');
require_once($_SERVER['DOCUMENT_ROOT'].'Models/KorisnikModel.php');
function getPDO() {
	return new PDO('mysql:host=localhost;dbname=wt8;charset=utf8', 'dbihorac', 'password1');
}
